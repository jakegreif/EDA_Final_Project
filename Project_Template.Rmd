...
class(trinity.raw$site_no)
class(westfork.raw$site_no)
...
trinity.thinned <- select(trinity.raw, site_no, datetime, discharge.mean)
westfork.thinned <- select(westfork.raw, site_no, datetime, discharge.mean)
