...
```{r Exploratory, include = FALSE, warning=FALSE, include=FALSE}
## Exploratory Graphsj
Figure1 <- ggplot(NULL, aes(x = discharge.mean)) +
  geom_histogram(data = trinity.flow, fill = "red") +
  geom_histogram(data = westfork.flow, fill = "blue", alpha = 0.5) +
  ylim(0,1500) +
  xlim(0,20000)
 
Figure2 <- ggplot(all.flow.data) +
...
Figure3 <- ggplot(trinity.flood.freq, aes(x = Year, y = n)) +
  geom_point() +
...
Figure4 <- ggplot(trinity.drought.freq, aes(x = Year, y = n)) +
  geom_point() +
...
Figure5 <- ggplot(westfork.flood.freq, aes(x = Year, y = n)) +
  geom_point() +
  geom_smooth(method = lm) +
...
Figure6 <- ggplot(westfork.drought.freq, aes(x = Year, y = n)) +
  geom_point() +
  geom_smooth(method = lm, color = "red") +
...
grid.arrange(Figure3, Figure4, Figure5, Figure6)
...
```{r Visual, warning=FALSE, include=FALSE}
# Visualization Graphs

# 1. Scatter plots of data with upper/lower 25% thresholds filled.
Figure7 <- ggplot(trinity.raw, aes(x = datetime, y = discharge.mean)) +
...
Figure8 <- ggplot(westfork.raw, aes(x = datetime, y = discharge.mean)) +
  geom_rect(xmin = as.Date("1925-01-01"), xmax = as.Date("2020-01-01"), 
...
Figure9 <- ggplot(trinity.flood.freq, aes(x = Year, y = n)) +
...
Figure10 <- ggplot(westfork.flood.freq, aes(x = Year, y = n)) +
  geom_point(position = position_jitter(height = 0L, seed = 1L),
      size = 0.5, color = "gray41", alpha = 0.25) +
  geom_linerange(aes(x=Year, ymin = 0, ymax = n),
      position = position_jitter(height = 0L, seed = 1L),
...
Figure11 <- ggplot(trinity.drought.freq, aes(x = Year, y = n)) +
  geom_point(position = position_jitter(height = 0L, seed = 1L),
      size = 0.5, color = "gray41", alpha = 0.25) +
  geom_linerange(aes(x=Year, ymin = 0, ymax = n),
      position = position_jitter(height = 0L, seed = 1L),
...
Figure12 <- ggplot(westfork.drought.freq, aes(x = Year, y = n)) +
  geom_point(position = position_jitter(height = 0L, seed = 1L),
      size = 0.5, color = "gray41", alpha = 0.25) +
  geom_linerange(aes(x=Year, ymin = 0, ymax = n),
      position = position_jitter(height = 0L, seed = 1L),
